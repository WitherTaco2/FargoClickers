...
namespace FargoClickers
{
    ...
    {
        public static bool RemoveClickerAccesoriesFromFargoSoulsForCSE { get; internal set; } = false;
        ...
        #region Grab and Tresure Bag recipes
        private static void AddGrabAndTresureBagRecipes()
        {
        ...
        #region Trophy recipes
        private static void AddTrophyRecipes()
        {
        ...
        public override void AddRecipeGroups()
        {
            ...
            /*Assembly code = FargoClickers.fargo.Code;
            var types = AssemblyManager.GetLoadableTypes(code);
            Type bookDataType = FindType(types, "Fargowiltas.Common.Systems.Recipes.RecipeGroups");*/
            Type t = typeof(RecipeGroups);
            AnyWoodCrate = (int)t.GetField("AnyWoodCrate", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Static).GetValue(null);
